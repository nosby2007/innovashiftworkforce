...
export function getClaims(ctx:any){ const a=requireAuth(ctx); const t=a.token||{}; return { uid:a.uid as string, orgId:t.orgId as string|undefined, accessRole:normalizeAccessRole(t.accessRole), platformRole:normalizePlatformRole(t.platformRole) as string|undefined, isDemo: t.isDemo===true }; }
