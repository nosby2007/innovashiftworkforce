...
export const APP_ROUTES: Routes = [
  ...
  // ── Authenticated app shell (/app/…) ────────────────────────────────────────
  {
    ...
    children: [
      ...
      { path: 'admin/industry-setup', redirectTo: '/admin/industry-setup', pathMatch: 'full' },
  ...
  // ── Organization admin shell (/admin/…) ───────────────────────────────────
  {
    ...
    children: [
      ...
      { path: 'industry-setup',       loadComponent: () => import('./features/admin/industry-setup.page').then(m => m.IndustrySetupPage) },
